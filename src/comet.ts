...
export async function deploy(deploymentManager: DeploymentManager, verify: boolean = false): Promise<{comet: Comet, oracle: MockedOracle, proxy: TransparentUpgradeableProxy}> {
