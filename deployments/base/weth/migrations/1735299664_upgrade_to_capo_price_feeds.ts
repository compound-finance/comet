...
export default migration('1735299664_upgrade_to_capo_price_feeds', {
  async prepare(deploymentManager: DeploymentManager) {
    ...
    const rateProivderRsEth = await ethers.getContractAt('contracts/capo/contracts/interfaces/AggregatorV3Interface.sol:AggregatorV3Interface', WRSETH_ORACLE) as AggregatorV3Interface;

    const [, currentRatioWrsEth] = await rateProivderRsEth.latestRoundData();
    ...
    const rateProviderWeEth = await ethers.getContractAt('contracts/capo/contracts/interfaces/AggregatorV3Interface.sol:AggregatorV3Interface', WEETH_STETH_PRICE_FEED_ADDRESS) as AggregatorV3Interface;
