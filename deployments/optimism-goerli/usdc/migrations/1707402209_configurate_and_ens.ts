...
export default migration('1707402209_configurate_and_ens', {
  ...
  enact: async (
    ...
    // Note: We aren't bridging USDC over to optimism Goerli because they don't use a bridged version of USDC there,
    const goerliActions = [
      ...
      // 3. Bridge COMP from Goerli to Optimism-Goerli Comet using L1StandardBridge
      {
    ...
    const description = 'Proposal text';
  ...
  async verify(
    ...
    expect(stateChanges).to.deep.equal({
      pauseGuardian: '0xBA5e81fD6811E2699b478d1Bcde62a585bC9b6f7', //// Should be updated to the correct address
      baseTrackingSupplySpeed: exp(34.74 / 86400, 15, 18), /// Should be updated to the correct value
      baseTrackingBorrowSpeed: exp(34.74 / 86400, 15, 18), /// Should be updated to the correct value
      baseBorrowMin: exp(1, 6), /// Should be updated to the correct value
      WETH: {
    ...
    ///// =========================================== all checks should be updated to the correct values after getting correct information
    ...
    expect(officialMarkets).to.deep.equal({
      /// Should parse before migration and update this
      5: [
        {
          baseSymbol: 'USDC',
