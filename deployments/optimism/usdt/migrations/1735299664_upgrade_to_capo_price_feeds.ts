...
import { AggregatorV3Interface, IERC4626, ILRTOracle, IWstETH } from '../../../../build/types';
...
export default migration('1735299664_upgrade_to_capo_price_feeds', {
  async prepare(deploymentManager: DeploymentManager) {
    ...
    const rateProviderWstEth = await deploymentManager.existing('wstETH:_rateProvider', STETH_ETH_PRICE_FEED_ADDRESS, 'optimism', 'contracts/capo/contracts/interfaces/AggregatorV3Interface.sol:AggregatorV3Interface') as AggregatorV3Interface;
