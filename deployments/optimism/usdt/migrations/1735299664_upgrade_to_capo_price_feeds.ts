...
export default migration('1735299664_upgrade_to_capo_price_feeds', {
  ...
  async enact(deploymentManager: DeploymentManager, govDeploymentManager, {
    ...
    const description = '# Upgrade wstETH to CAPO price feed on Optimism cUSDTv3\n\n## Proposal summary\n\nThis proposal upgrades the wstETH price feed to use the new CAPO (Chainlink Correlated Assets Price Oracle) implementation on Optimism cUSDTv3. This upgrade enhances the security and reliability of the wstETH price feed by implementing additional safeguards against price manipulation and ensuring more robust price discovery.\n\n## Proposal Actions\n\nThe proposal action updates the wstETH price feed in the USDT Comet on Optimism and deploys the updated configuration.';
