...
// TODO: Need to figure out how much USDT we're going to seed to the comet
const USDTAmountToSeed = exp(5, 6);

export default migration('1691448188_configurate_and_ens', {
  ...
  enact: async (deploymentManager: DeploymentManager) => {
    ...
    const ENSResolver = await deploymentManager.existing('ENSResolver', ENSResolverAddress, 'mainnet');
    ...
    // TODO: Need to formalize the description for the proposal
    const description = "# Initialize cUSDTv3 on Mainnet"
