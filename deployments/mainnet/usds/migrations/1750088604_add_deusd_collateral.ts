...
export default migration('1750088604_add_deusd_collateral', {
  ...
  async enact(deploymentManager: DeploymentManager) {
    ...
    const description = '# Add deUSD as collateral into cUSDSv3 on Mainnet\n\n## Proposal summary\n\nWOOF! proposes to add deUSD into cUSDSv3 on Ethereum network. This proposal takes the governance steps recommended and necessary to update a Compound III USDS market on Ethereum. Simulations have confirmed the market’s readiness, as much as possible, using the [Comet scenario suite](https://github.com/compound-finance/comet/tree/main/scenario). The new parameters include setting the risk parameters based on the [recommendations from Gauntlet](https://www.comp.xyz/t/add-collateral-deusd-sdeusd-staked-on-usdc-usds-usdt-on-mainnet/6112/6).\n\nFurther detailed information can be found on the corresponding [proposal pull request](https://github.com/compound-finance/comet/pull/993) and [forum discussion](https://www.comp.xyz/t/add-collateral-deusd-sdeusd-staked-on-usdc-usds-usdt-on-mainnet/6112).\n\n\n## Proposal Actions\n\nThe first action adds deUSD asset as collateral with corresponding configurations.\n\nThe second action deploys and upgrades Comet to a new version.';
