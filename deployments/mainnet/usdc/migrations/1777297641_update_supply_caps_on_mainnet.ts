...
export default migration('1777297641_update_supply_caps_on_mainnet', {
  ...
  async enact(deploymentManager: DeploymentManager) {
    ...
    const description = `# Ethereum Supply cap Reduction Across Comets

## Proposal summary

This proposal updates supply caps for a number of assets across the Mainnet markets. The supply caps for the affected assets are being updated based on their current utilization and risk parameters.
...
19 - 25. Updates supply caps for weETH and mETH to 0 and tBTC to 73, sFRAX to 33M, UNI to 310,336, and LINK to 210,317 on cUSDTv3 market and upgrades the Comet implementation to apply the changes.

26 - 28. Updates supply caps for weETH and tBTC to 0 on cUSDSv3 market and upgrades the Comet implementation to apply the changes.

29 - 32. Updates supply caps for tBTC to 40, UNI to 364,691, and LINK to 585,990 on cUSDCv3 market and upgrades the Comet implementation to apply the changes.
`;
