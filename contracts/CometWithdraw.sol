 ...
 * @author Compound
 */
contract CometWithdraw is CometCore {
    /** Custom events **/
     ...
     */
    function withdrawReserves(address to, address asset, uint amount) external {
        ...
        if (asset == baseToken) {
            ...
            isAllowed[address(this)][msg.sender] = true;
            withdrawInternal(msg.sender, address(this), to, asset, amount);
            isAllowed[address(this)][msg.sender] = false;
        }
    }
