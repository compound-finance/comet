...
contract CometHarnessPartialLiquidation is CometWithPartialLiquidation {
    uint public nowOverride;

    constructor(Configuration memory config) CometWithPartialLiquidation(config) {}
