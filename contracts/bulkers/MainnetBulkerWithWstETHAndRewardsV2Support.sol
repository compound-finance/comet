...
import "./BaseBulkerWithRewardsV2Support.sol";
import "../IWstETH.sol";
 ...
 * @author Compound
 */
contract MainnetBulkerWithWstETHAndRewardsV2Support is BaseBulkerWithRewardsV2Support {
    ...
    constructor(
        ...
        address wsteth_
    ) BaseBulkerWithRewardsV2Support(admin_, weth_) {
        wsteth = wsteth_;
