 ...
 * @author Compound
 */
contract CometWithCOMPDelegation is CometMainInterface {
    ...
    function updateDelegationTarget(address newDelegationTarget) external {
        if (msg.sender != governor) revert Unauthorized();
        ITokenWithDelegate(0xc00e94Cb662C3520282E6f5717214004A7f26888).delegate(newDelegationTarget);
    }
