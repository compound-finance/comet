...
contract ConfiguratorPartialLiquidation is ConfiguratorStorage {
    ...
    **/
    ...
    function setTargetHealthFactor(address cometProxy, uint256 newTargetHealthFactor) external governorOrMarketAdmin {
