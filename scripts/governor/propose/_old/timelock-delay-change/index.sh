...
show_help() {
    ...
    echo ""
    echo "Usage: ./scripts/governor/propose/_old/timelock-delay-change/index.sh [options]"
    echo ""
    echo "Options:"
    ...
    echo "  ./scripts/governor/propose/_old/timelock-delay-change/index.sh -n local"
    echo ""
    echo "  # Change timelock delay on mainnet (delay will be asked interactively)"
    echo "  ./scripts/governor/propose/_old/timelock-delay-change/index.sh -n mainnet"
    echo ""
