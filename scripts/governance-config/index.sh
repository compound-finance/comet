...
show_help() {
    ...
    echo ""
    echo "Usage: ./scripts/governance-config/index.sh [options]"
    echo ""
    echo "Options:"
    ...
    echo "  ./scripts/governance-config/index.sh -n local -d dai"
    echo ""
    echo "  # Change governance configuration on polygon network (interactive)"
    echo "  ./scripts/governance-config/index.sh -n polygon -d usdc"
    echo ""
